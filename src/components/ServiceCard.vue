    ...
    data() {
        return {
            services: [
                {
                    title: "Back-End",
                    text: "I build APIs that will facilitate communication between your web client and your database. User management, stock management, real-time chat integration.",
                    imgPath: "./api.png",
